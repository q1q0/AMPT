...
function buildUrl(params: {
  ...
  console.log(`encodeTokenSymbol(${JSON.stringify(sellToken)})-encodeTokenSymbol(${buyToken})`)
...
const TradeWidget: React.FC = () => {
  ...
  console.log(`networkId:${networkId},networkIdOrDefault:${networkIdOrDefault}`)
  ...
  useEffect(() => {
    ...
    if (trade.sellToken) {
      ...
      const sellTokenOrFallback = chooseTokenWithFallback({
        ...
        defaultTokenSymbol: 'WETH', // default sellToken
      })
    ...
    if (trade.buyToken) {
      const buyTokenOrFallback = chooseTokenWithFallback({
        ...
        tokenSymbolFromUrl: receiveTokenSymbol,
        defaultTokenSymbol: 'AMPT', // default buyToken
      })
