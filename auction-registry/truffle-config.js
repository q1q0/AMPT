...
const address_ropsten = process.env.address_ropsten;

const privatekey_rinkeby = process.env.privatekey_ropsten;
const address_rinkeby = process.env.address_ropsten;
